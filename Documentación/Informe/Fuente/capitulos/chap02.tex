...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/marco_teorico/model_transformation.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/marco_teorico/profile-servers.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/marco_teorico/acceleo.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/marco_teorico/diagrama_eclases.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/marco_teorico/salida_router.png}

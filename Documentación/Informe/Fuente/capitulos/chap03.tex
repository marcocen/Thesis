...
%A continuación se detallan algunos requerimientos adicionales que, debido a su complejidad y trabajo necesario para su implementación, son considerados de forma separada a los mencionados anteriormente. 
